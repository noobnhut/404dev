<template>
   <div class="w-full h-full bg-gray-800 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0 z-[100]"
        id="chec-div">
    ...
    <div class=" fixed w-full h-full top-0 left-0 flex items-center justify-center z-50 " v-if="isShowdelete">
        <div class="absolute w-full h-full bg-gray-600 opacity-50" @click="onclosedelete"></div>
